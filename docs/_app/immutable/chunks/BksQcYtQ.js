...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ta(e,t,n){let r=new Float32Array(da),i=new q(0,1,0);return new ei({name:`SphericalGaussianBlur`,defines:{n:da,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Oa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ea(){return new ei({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Oa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Da(){return new ei({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Oa(),fragmentShader:`
...
`;function vc(){function e(e){return`
			uniform sampler2D uTexture;
	...
	`)}}var yc=class extends gc{speed;clock;constructor(e,t){let n={vertex:_c,fragment:{vertical:vc().vertical,horizontal:vc().horizontal}},r={uTime:{value:0},uOffset:{value:new K(0,0)},uAlpha:{value:.7}};super(e,t,n,e.parentElement,r),this.clock=new Yi}createMesh(){super.createMesh(),this.element.parentElement.style.visibility=`hidden`}render(){super.render(),this.speed=e.speed,this.uniforms.uOffset.value.set(this.speed*-3e-4,Math.abs(this.speed*5e-5)),this.uniforms.uTime.value=this.clock.getElapsedTime()*.8}},bc=class extends hc{meshItems;images;constructor(e,t){super(e),this.images=t,this.meshItems=[],this.setup()}setup(){this.images.forEach(e=>{let t=new yc(e,this.scene);this.meshItems.push(t)}),super.setup()}render(){for(let e=0;e<this.meshItems.length;e++)this.meshItems[e].render();super.render()}};export{bc as ImageRenderer};